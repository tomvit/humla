...
Controler = function(window) {
  ...
  // controller state; changed to 'complete' when controller is running
  ...
  this.run = function() {
    ...
    humla.utils.loadScripts(function() {
      ...
      ctrl.readyState = 'complete';
      ctrl.callExtensionsInterface('load')
    }, scripts);
  };
  ...
  this.keydown = function(event) {
    ...
    this.callExtensionsInterface('keydown', event)
  };
